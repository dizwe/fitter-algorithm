...
var tall = 1000; //키기준
var broad = 700; //어깨기준
var real_tall = one_body['104'];
var real_broad = one_body['223']*2;
...
var my = {
  'trunk_leg' : one_body['128']+one_body['129'],
  'shoulder' : one_body['223'],
...
var topDot = [
  //어깨
  {x: broad/2-realBroadToRatio(shirt['shoulder']/2),
  y: realTallToRatio(my['trunk_leg'])},//어깨왼쪽
  {x: broad/2+realBroadToRatio(shirt['shoulder']/2),
  ...
  y: realTallToRatio(my['trunk_leg']-(one_body['233']-one_body['234']))},//가슴왼쪽
  {x: broad/2+realBroadToRatio(shirt['chest']/3.14),
  y: realTallToRatio(my['trunk_leg']-(one_body['233']-one_body['234']))},//가스왼쪽
  // 기장
  {x: broad/2-realBroadToRatio(shirt['chest']/3.14),
  ...
  // 소매
  {x: broad/2-realBroadToRatio(shirt['chest']/3.14),
  y: realTallToRatio(my['trunk_leg']-((shirt['shoulder']-my['shoulder'])+shirt['sleeve']))},//소매 왼쪽 -어깨연결
  {x: broad/2+realBroadToRatio(shirt['chest']/3.14),
  y: realTallToRatio(my['trunk_leg']-((shirt['shoulder']-my['shoulder'])+shirt['sleeve']))},//어깨왼쪽
]
